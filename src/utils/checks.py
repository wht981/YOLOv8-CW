...
def collect_system_info():
    ...
    from src.utils import ENVIRONMENT  # scope to avoid circular import
    from src.utils.torch_utils import get_cpu_info, get_gpu_info
...
def is_intel():
    ...
    """
    from src.utils.torch_utils import get_cpu_info

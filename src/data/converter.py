...
from src.utils import ASSETS_URL, DATASETS_DIR, LOGGER, NUM_THREADS, TQDM, YAML
from src.utils.checks import check_file, check_requirements
from src.utils.downloads import download, zip_directory
...
def convert_to_multispectral(path: str | Path, n_channels: int = 10, replace: bool = False, zip: bool = False):
    ...
    from src.data.utils import IMG_FORMATS

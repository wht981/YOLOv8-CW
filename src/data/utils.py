...
from src.utils.checks import check_file, check_font, is_ascii
from src.utils.downloads import download, safe_download, unzip_file
...
def check_cls_dataset(dataset: str | Path, split: str = "") -> dict[str, Any]:
    ...
    if not train_set.is_dir():
        ...
        if image_files := list(data_dir.rglob("*.jpg")) + list(data_dir.rglob("*.png")):
            from src.data.split import split_classify_dataset
...
class HUBDatasetStats:
    ...
    def process_images(self) -> Path:
        ...
        from src.data import YOLODataset  # ClassificationDataset
